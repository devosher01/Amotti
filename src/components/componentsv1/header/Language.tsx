...
const Language = () => {
  ...
  useEffect(() => {
    // ✅ DEFENSIVE: Verificar que i18n está inicializado
    if (i18n && typeof i18n.changeLanguage === 'function') {
      i18n.changeLanguage(customizer.isLanguage);
    } else {
      console.warn('⚠️ i18n no está inicializado aún, reintentando...');
        ...
        {Languages.map((option, index) => (
          <MenuItem
            ...
            onClick={() => {
              ...
              // ✅ DEFENSIVE: Cambiar idioma solo si i18n está disponible
              if (i18n && typeof i18n.changeLanguage === 'function') {
